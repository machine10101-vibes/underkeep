...
**https://machine10101-vibes.github.io/underkeep/?v=pass10.25**

Pass 10 play: the keeper loop follows the classic dungeon-keeper playthrough — dig, claim, fortify, rooms, Portal, payday, Heart defense — with Underkeep names and unique gold-cost workers. Pass 10.1: Scrabblers keep digging when the vault is full, and Dig paint marks only the tiles you sweep. Pass 10.2: **Studio (V)** inspects every creature, item, enemy, and room mesh. Pass 10.6: torch-lit cavern (no dig-load brightness snaps), Prison/Workshop loops actually tick, HUD stays on-screen. Pass 10.7: Fortify is a Keeper mark only; the first hero party waits until the keep is built. Pass 10.8: the Portal is a 3×3 gateway buried on the map — dig to it and claim it; it cannot be built. Pass 10.9: Scrabblers chip only tagged blocks; gold reads as ore in dirt. Pass 10.10: graphics hiccups resume without a forced reload; gold nuggets read clearly in the dirt. Pass 10.11: gold chunks sit on the cube tops so the keeper overview sees the same ore as the side faces. Pass 10.12: gold ore no longer wears a lid border; tagged soil uses that gold edge instead of a red square. Pass 10.13: wall torches throw brighter, farther pools of light. Pass 10.14: the last graphics hiccup was 12 high-intensity torch PointLights plus bloom lighting hundreds of gold chunks — now a 4-light pool, no default bloom, instanced nuggets. Pass 10.15: minions and heroes wear distinct silhouettes that match their names. Pass 10.16: each species gets readable anatomy — beetle worker, dragonfly scout, skull fighter, lava salamander, hooded mage, thorn mistress, hunched wretch, plate knight, woods archer. Pass 10.17: flyers path lava, Fortify stops when you unmark, Heart HP and prison state persist, Dig/Claim paint on press, camera and Hand feel tighter. Pass 10.18: another species-detail pass, plus gaits and strikes that match each body — scuttle, flap, limp, lunge, chop, draw. Pass 10.19: each species plays a real strike — wind-up, hit, and follow-through — with gaits that match the body (scuttle, limp, slither, heavy march). Pass 10.20: tools sit in fists, the archer draws with the right hand, and humanoid arms bend at the elbow so walks and chops read as real. Pass 10.21: another species-true body pass — beetle horn and split elytra, dragonfly eyes and banded tail, skull brow and ribs, salamander maw, void-cowl mage, hourglass witch, hunched wretch, T-visor knight, hooded ranger with a face. Pass 10.22: the hero archer wears one cowl on one head, and holds a vertical recurve and a fletched arrow instead of a torus and a stick. Pass 10.23: living idles and species gaits — antennae twitch, jaws chatter, hair sways, dragonfly hovers, and Studio walks use each kind’s real cadence. Pass 10.24: another species-true body pass — beetle horn and split elytra from above, dragonfly stinger and banded tail, skull brow and zygoma, salamander snout and lava ridge, void-cowl mage, hourglass witch with a thicker lash, floor-scraping wretch, punched T-visor knight, one-head ranger. Pass 10.25: clearer species silhouettes (wider beetle seam, thicker recurve, brighter salamander ridge) plus keeper-loop fixes — save/load keeps job targets and beds, last-worker death no longer wipes the dungeon, hero waves no longer vault carved ore, Scrabblers cannot eat/sleep.
