...
if (
  ...
  (params.get('shot') === '1' ||
    ...
    params.get('shot') === '10.18' ||
    params.get('shot') === '1018' ||
    ...
    params.get('shot') === '10.22' ||
    params.get('shot') === '1022' ||
    params.get('shot') === '10.23' ||
    params.get('shot') === '1023' ||
    params.get('shot') === '10.24' ||
    params.get('shot') === '1024' ||
    params.get('shot') === '10.25' ||
    params.get('shot') === '1025')
) {
  ...
  setTimeout(() => {
    ...
    if (shot === '10.25' || shot === '1025') g.preparePass1025Shot?.();
    else if (shot === '10.24' || shot === '1024') g.preparePass1024Shot?.();
    else if (shot === '10.23' || shot === '1023') g.preparePass1023Shot?.();
    else if (shot === '10.22' || shot === '1022') g.preparePass1022Shot?.();
    else if (shot === '10.21' || shot === '1021') g.preparePass1021Shot?.();
    else if (shot === '10.20' || shot === '1020') g.preparePass1020Shot?.();
    else if (shot === '10.19' || shot === '1019') g.preparePass1019Shot?.();
    else if (shot === '10.18' || shot === '1018') g.preparePass1018Shot?.();
    else if (shot === '10.16' || shot === '1016') g.preparePass1016Shot?.();
